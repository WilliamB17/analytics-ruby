...
module SmlibSegment
  class Analytics
    describe Analytics do
      let(:analytics) { SmlibSegment::Analytics.new :write_key => WRITE_KEY, :stub => true }
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of SmlibSegment::Analytics::Client' do
          expect(analytics).to respond_to(*SmlibSegment::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        SmlibSegment::Analytics::Client.public_instance_methods(false).each do |public_method|
