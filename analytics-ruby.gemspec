...
Gem::Specification.new do |spec|
  ...
  spec.version = SmlibSegment::Analytics::VERSION
  spec.files = Dir.glob('{lib,bin}/**/*')
  spec.require_paths = ['lib']
  spec.bindir = 'bin'
  spec.executables = ['analytics']
  spec.summary = 'SmlibSegment.io analytics library'
  spec.description = 'The SmlibSegment.io ruby analytics library'
  spec.authors = ['SmlibSegment.io']
